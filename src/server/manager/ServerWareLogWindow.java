...
public class ServerWareLogWindow extends JInternalFrame {
	private JTextPane textPane = null;
	private JScrollPane pScroll = null;

	public ServerWareLogWindow(String windowName, int x, int y, int width, int height, boolean resizable, boolean closable) {
		super();
	...
	public void savelog() {
		try {
			...
			synchronized (eva.lock) {
				...
				eva.flush(textPane, "[" + eva.time + "] 0.Ã¢°í", eva.date);
				sTemp = null;
				eva.date = null;
				eva.time = null;							
			}
