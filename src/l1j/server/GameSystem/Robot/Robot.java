...
public class Robot {
	...
	public static void poly(L1RobotInstance bot) {
		...
		if (rr == 0 || (bot.리스봇_스폰위치 == 1 && _random.nextInt(10) < 8)) {
			...
			if (bot.getLevel() > 51) { // 51레벨 이상
				polyNormal51(bot);
			} else if (bot.getLevel() > 54) { // 54레벨 이상
				polyNormal54(bot);
			} else if (bot.getLevel() > 84) { // 84레벨 이상
				polyNormal84(bot);
			} else {
				polyNormal2(bot); // 그렇지않을경우
			}
		}
	}
	...
	private static void polyNormal51(L1RobotInstance bot) { // 로봇변신
		if (bot.사냥봇) {
			if (bot.isElf() && bot.getCurrentWeapon() == 20) {
				...
				if (f == 0)
					bot.getGfxId().setTempCharGfx(11378); // 다크엘프
				else if (f == 1)
					bot.getGfxId().setTempCharGfx(11386); // 실버 레인저
				else if (f == 2)
					bot.getGfxId().setTempCharGfx(11394); // 아크 스카우트
				else if (f == 3)
					bot.getGfxId().setTempCharGfx(15848); // 포노스 오크 궁수
			} else {
				int f1 = _random.nextInt(4);
				if (f1 == 0 && bot.isKnight())
					bot.getGfxId().setTempCharGfx(11392); // 아크 나이트
				else if (f1 == 1 && bot.getCurrentWeapon() != 20)
					bot.getGfxId().setTempCharGfx(11329); // 해골
				else if (f1 == 2 && bot.isDragonknight()) // 용기사
					bot.getGfxId().setTempCharGfx(11447); // 나이트 워치
	...
	private static void polyNormal54(L1RobotInstance bot) { // 로봇변신
		if (bot.사냥봇) {
			if (bot.isElf() && bot.getCurrentWeapon() == 20) {
				int f = _random.nextInt(4);
				if (f == 0)
					bot.getGfxId().setTempCharGfx(15848); //포노스 오크
				else if (f == 1)
					bot.getGfxId().setTempCharGfx(15848); //포노스 오크
				else if (f == 2)
					bot.getGfxId().setTempCharGfx(13346); //진 다크엘프
				else if (f == 3)
					bot.getGfxId().setTempCharGfx(13346); //진 다크엘프
			} else {
				int f1 = _random.nextInt(4);
				if (f1 == 0 && bot.isKnight())
					bot.getGfxId().setTempCharGfx(12702); // 75 진데스
				else if (f1 == 1 && bot.getCurrentWeapon() != 20)
					bot.getGfxId().setTempCharGfx(12702); // 75 진데스
				else if (f1 == 2 && bot.isDragonknight())
					bot.getGfxId().setTempCharGfx(15834); // 75 랜스 마스터
				else if (f1 == 3 && bot.getCurrentWeapon() != 20)
					bot.getGfxId().setTempCharGfx(12702); // 75 진데스
				else
					bot.getGfxId().setTempCharGfx(12702); // 75 진데스
	...
	private static void polyNormal84(L1RobotInstance bot) { // 로봇변신
		if (bot.사냥봇) {
			if (bot.isElf() && bot.getCurrentWeapon() == 20) {
				int f = _random.nextInt(4);
				if (f == 0)
					bot.getGfxId().setTempCharGfx(15814); // 80 하이엘프
				else if (f == 1)
					bot.getGfxId().setTempCharGfx(15814); // 80 하이엘프
				else if (f == 2)
					bot.getGfxId().setTempCharGfx(15814); // 80 하이엘프
				...
				int f1 = _random.nextInt(4);
				if (f1 == 0 && bot.isKnight())
					bot.getGfxId().setTempCharGfx(12681); // 80 진데스
				else if (f1 == 1 && bot.getCurrentWeapon() != 20)
					bot.getGfxId().setTempCharGfx(12681); // 80 진데스
				else if (f1 == 2 && bot.isDragonknight())
					bot.getGfxId().setTempCharGfx(15534); // 80 진 랜스마스터
				else if (f1 == 3 && bot.getCurrentWeapon() != 20)
					bot.getGfxId().setTempCharGfx(12681); // 80 진데스
				else
					bot.getGfxId().setTempCharGfx(12681); // 80 진데스
	...
	private static void polyNormal2(L1RobotInstance bot) { // 로봇변신
		if (bot.사냥봇) {
			if (bot.isElf() && bot.getCurrentWeapon() == 20) {

				int f = _random.nextInt(4);
				if (f == 0)
					bot.getGfxId().setTempCharGfx(13388); // 52 다엘 -> 빨간경비병85
				else if (f == 1)
					bot.getGfxId().setTempCharGfx(13725); // 랭커 여엘프
				else if (f == 2)
					bot.getGfxId().setTempCharGfx(11406); // 질리언
				else if (f == 3)
					bot.getGfxId().setTempCharGfx(13631); // 오크궁수 -> 오웬

			} else {

				int f1 = _random.nextInt(4);
				if (f1 == 0 && bot.isKnight())
					bot.getGfxId().setTempCharGfx(13719); // 13719 랭커기사
				else if (f1 == 1 && bot.getCurrentWeapon() != 20)
					bot.getGfxId().setTempCharGfx(13153); // 걍데쓰 -> 80 진데쓰
				else if (f1 == 2 && bot.isDragonknight())
					bot.getGfxId().setTempCharGfx(13735); // 랭커 용기사
				else if (f1 == 3 && bot.getCurrentWeapon() != 20)
					bot.getGfxId().setTempCharGfx(13152); // 85진데쓰
				else
					bot.getGfxId().setTempCharGfx(13153); // 신커츠
