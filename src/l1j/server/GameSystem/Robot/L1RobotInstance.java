...
public class L1RobotInstance extends L1PcInstance {
	...
	private static final String[] himentArray = { "ㅎㅇ", "5초준다 베르해라", "구경하지마" , "하이?" , "님?", "저리가라", "싸우는거 첨보냐?"};*/

	private String _townment;
	private static final String[] townmentArray = { "아 렉보소", "나만 튕김??", "톡들어와", "ㄱㄱㄱㄱ","잠만 나약좀","ㅇㅇ","ㅋㅋㅋㅋㅋ","디질뻔ㅋ",
			"ㅇㅇㅇ","톡함?","아 형","ㅡㅡ","?","ㅅㅂㅋㅋㅋ","형","ㅇㅇ?","자동개많네;;"};
	
	/*private String _disment;
	private static final String[] dismentArray = { "님  ", "님 잠만요", "님?" , "님 잠만서봐요" , " 님 잠시만~", " 님"};*/
	
	private String _glment;
	private static final String[] glmentArray = {"할파스 어디서 잘나오나요?", "기던 1~4층 할파스 잘나옴", "9나발삽니다.","기감 뒷치기 졸래 해쌌네",
			"용던 막피좀 그만해라 ㅅㅂ","영생의빛 다삽니다","필드 하실 혈원 모집합니다. 기란 마을 여관앞ㄱㄱ","집행검 ㅅㅅㅅ","영생의빛 ㅅㅅㅅ","집행검 팝니다.","가이아의 격노 급구해봅니다.","쌈잘하는 혈원 모집중 기란마을 여관앞 ㄱㄱ",
			"기감1층 쌈하러 오세요","잊섬 파티사냥 하실분 구해요","잊섬 어찌감요?","렙업 어디서 하나요?","잊섬 사냥 같이해요"
			,"영생의빛 비싸게 삽니다", "히페절망 사봐요 ㅅㅅㅅ", "집행검 ㅅㅅㅅㅅ","9이상 무기 다삼","9극체ㅍㅍㅍㅍㅍ"
			,"9신묘활 싸게 팝니다.","9흑왕도 팔아요","9이상 나발검사봄","9태풍도끼 쌍수팜"};
