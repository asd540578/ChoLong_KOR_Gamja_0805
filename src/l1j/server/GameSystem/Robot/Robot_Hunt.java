...
public class Robot_Hunt {
	...
	private static final String[] mapName = { "지저", "개미굴1", "개미굴2", "개미굴3",
			...
			"기감1층", "기감2층" , "기감3층" , "기감4층" , 
              "리뉴얼오만1층" , "리뉴얼오만2층" , "리뉴얼오만3층" , "리뉴얼오만4층" , "리뉴얼오만5층" , "리뉴얼오만6층" , "리뉴얼오만7층" , "리뉴얼오만8층" , "리뉴얼오만9층", "리뉴얼오만10층",
	/* "상아탑4층", "상아탑5층" */};
	...
	private static final int[] mapCount = { 0, // 지저
			...
			0, 0, 0, 0, 0, 0, 0, //본던 
			20, 20, 20, 20,// 기감
			20, 20, 20 ,20 ,20 ,20 ,20 ,20 ,20 ,0 //리뉴얼오만
         	};
	...
	public void start_spawn() {
		for (int a = 0; a < mapCount.length; a++) {
			...
			for (int i = 0; i < mapCount[a]; i++) {
				...
				if (bot == null)
					continue;
				GeneralThreadPool.getInstance().schedule(new botVisible(bot, mapName[a]), 6000 * (_random.nextInt(50))); //원래 120
	...
	private void loadbot() {
		...
		try {
			...
			while (rs.next()) {
				...
				// rs.getInt("step");
				int level = _random.nextInt(10) + 70; //사냥 로봇레벨
