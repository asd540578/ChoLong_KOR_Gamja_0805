...
public class L1LittleBugInstance extends L1NpcInstance {
	...
	private String[] Name = { "배크두", "투투", "버기", "얼루", "제프리", "카이", "아돌프", "오버풋", "럼프스", "부카", "그룩", "쿤드라", "쿠마토", "두렉",
			"그로돈", "퀘니버", "플루토", "두리바", "버루얼", "일레자" };
	private static final int[] gfxId = { 3478, 3479, 3480, 3481, 3497, 3498, 3499, 3500, 3501, 3502, 3503, 3504, 3505,
