...
public class Resistance {
	...
	public void init() {
		...
		stun = petrifaction = sleep = freeze = blind = horror = calcPcDefense = PVPweaponTotalDamage = 0;
	}
	...
	public void addhorror(int i) {
		horror = checkRange(horror + i);
	}
