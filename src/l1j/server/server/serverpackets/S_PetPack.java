...
public class S_PetPack extends ServerBasePacket {
	...
	public S_PetPack(L1PetInstance pet, L1PcInstance pc) {
		/*
		 * if(pet.getMaster() == null){return;} L1PcInstance master =
		 * L1World.getInstance().getPlayer(pet.getMaster().getName()); if(master
		 * == null){return;} if(master.getId() != pc.getId()){return;}
		 */
		buildPacket(pet, pc);
	}
