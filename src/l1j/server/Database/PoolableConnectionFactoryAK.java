 ...
 * @author -Cain-
 */
public class PoolableConnectionFactoryAK extends PoolableConnectionFactory {
	/**
	...
	/**
	 * Create a new <tt>PoolableConnectionFactoryAL</tt>.
	 * 
	 * @param connFactory
	 ...
	 *            {@link java.sql.PreparedStatement}s, or <tt>null</tt> to
	 *            disable {@link java.sql.PreparedStatement} pooling
	 ...
	 *            {@link Connection}s
	 */
	public PoolableConnectionFactoryAK(ConnectionFactory connFactory,
	...
	public void validateConnection(Connection conn) throws SQLException {
		if (conn.isClosed())
			throw new SQLException("validateConnection: ¿¬°áÀÌ ´ÝÈû.");
		if (validationTimeout >= 0 && !conn.isValid(validationTimeout))
			throw new SQLException("validateConnection: ¿¬°áÀÌ Àß¸øµÊ.");
	}
}
